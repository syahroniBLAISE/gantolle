...
class Auth extends CI_Controller
{
    ...
    public function index()
    {
        ...
        switch ($index) {
            ...
            case 2:
                ...
                $this->load->view('templates/H_footer', $data);
    ...
    {
        $this->load->view('pendaftaran/jquery');
    }
    ...
    public function pilihan($pilihan = '')
    {
        if ($pilihan === 'peserta') {
            ...
            $data['menu'] = $this->db->get('datapilot')->result_array();
            $this->load->view('pendaftaran/gantolle', $data);
        }
        if ($pilihan === 'Admin') {
